% -------------------------------------------------------------------------------------------------------------------------
function [newTargetPosition, bestScale] = tracker_eval(net_x, s_x, scoreId, z_features, x_crops, targetPosition, window, mot_response,p)
%TRACKER_STEP
...
% -------------------------------------------------------------------------------------------------------------------------
    ...
    responseMaps = bsxfun(@times,responseMaps,mot_response);
